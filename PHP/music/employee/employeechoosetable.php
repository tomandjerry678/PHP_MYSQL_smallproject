...
if(!empty($data_input)){
  if ($data_input[0] == 'usertable'){
    header("Location: http://localhost/~xiaomengli/phptesting/music/employee/implementchoosing.php");
    exit;
  }
...
<html>
<head>
<title>Choose your table to change, employee</title>
</head>

<form action="http://localhost/~xiaomengli/phptesting/music/employee/employeechoosetable.php" method="post">
<b>Choose a table to manipulate, employee</b>
<p>adj table
