...
if ($chosentable == 'verbtable') {
  if(empty($data_missing)){
    ...
    $mysqli->close();
    header("Location: http://localhost/~xiaomengli/phptesting/music/employee/employee_insert_display.php");
    exit;
  }
...
<form action="http://localhost/~xiaomengli/phptesting/music/employee/employee_insert_nonuser.php" method="post">
