...
if ($chosentable == 'usertable') {
  ...
  $query = "SELECT Account, Password, email, salary FROM usertable";
  ...
  $mysqli = new mysqli(SERVER, DBUSER, DBPASS, DATABASE);
  $query = "SELECT base_noun FROM nountable";
  $response = @mysqli_query($mysqli, $query);
  ...
  $mysqli = new mysqli(SERVER, DBUSER, DBPASS, DATABASE);
  $query = "SELECT base_adjective, comparative, superlative FROM adjtable";
  $response = @mysqli_query($mysqli, $query);
  ...
  $mysqli = new mysqli(SERVER, DBUSER, DBPASS, DATABASE);
  $query = "SELECT adverb FROM advtable";
  $response = @mysqli_query($mysqli, $query);
  ...
  $mysqli = new mysqli(SERVER, DBUSER, DBPASS, DATABASE);
  $query = "SELECT base_verb, past, past_participle FROM verbtable";
  $response = @mysqli_query($mysqli, $query);
...
<html>
<head>
<title> Showing you everything, boss</title>
</head>
<form action="http://localhost/~xiaomengli/phptesting/music/boss/boss_select.php" method="post">
<p>
</p>
</form>
</body>
